...
/////
   await page.getByTestId('AM-MAR-RR-AAR-request-type-dropdown-button').click();
   await page.waitForTimeout(800);
  await page.getByRole('listitem').filter({ hasText: 'Retired' }).click();
  await page.waitForTimeout(800);
  await page.getByTestId('AM-MAR-RR-AAR-retire-asset-input').click();
  await page.waitForTimeout(800);
